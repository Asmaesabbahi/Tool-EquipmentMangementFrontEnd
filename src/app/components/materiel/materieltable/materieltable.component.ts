...
@Component({
  selector: 'app-materieltable',
  templateUrl: './materieltable.component.html',
  styleUrls: ['./materieltable.component.css']
})
export class MaterieltableComponent implements OnInit {
